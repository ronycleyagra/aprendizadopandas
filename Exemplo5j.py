...
cnxn = pyodbc.connect('DRIVER={Sql Server};SERVER=10.16.4.39;DATABASE=***;UID=***;PWD=***') 
cursor = cnxn.cursor()
...
cnxn = pyodbc.connect('DRIVER={Sql Server};SERVER=10.16.4.39;DATABASE=siacnet;UID=ronycleyagra;PWD=mrrm!@4mrrm') 
cursor = cnxn.cursor()
sql = ("""select distinct(codrealizacao) as qtdrealizacoes, mesanocompetencia from historicorealizacoescliente""")
